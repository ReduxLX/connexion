...
import TeamImg from "../../res/images/team2.jpg";
import { PageWrapper } from "../SharedStyles";
import Theme from "../../Theme";

const AboutUsText = `Hello dear viewer, we are a brother-sister team studying at Monash University Malaysia. On the left is myself, Alfons Fernaldy, and on the right is my sister, Michelle Adeline. This project represents our final submission for the Monash Quickhack Hackathon 2021 which was about "Connecting the past present and future". We thought of many solutions to this problem but came to a realization that Monash lacked a truly unified platform where current, past and future students could discuss matters freely. Thus this was how Connexion was born.`;
